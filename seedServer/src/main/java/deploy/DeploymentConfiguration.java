...
//        UserFacade uf = new UserFacade(Persistence.createEntityManagerFactory("pu_development"));
        ...
        try {
            ...
            String image = "https://scontent-amt2-1.xx.fbcdn.net/v/t1.0-9/20294416_1695690513792031_5913082279411205996_n.jpg?oh=1fb3d32cade5e09fd246d395b402b0d2&oe=5A67376A";
            Place place = new Place(address, "hfhw", rating, image);
            ...
            Place place2 = new Place(address2, "hfhw", rating2, image);
            ...
            Place place3 = new Place(address3, "hfhw", rating3, image);
            em.persist(address);
            em.persist(address2);
            em.persist(address3);
            em.persist(place);
